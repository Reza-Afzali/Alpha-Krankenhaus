...
// Hinweis: Dieser Codeabschnitt ist noch nicht fertiggestellt und wird in einem zukünftigen Update unseres Projekts als neue Funktion enthalten sein.
...
<main class="container main-content career-page">
    <section class="secondary" id="career-intro" style="text-align: center; padding: 40px 0;">
        ...
        <p style="font-size: 1.1rem; max-width: 800px; margin: 0 auto 30px;">
            Werden Sie Teil unseres Teams! Wir bieten Ihnen die Möglichkeit, in einem modernen und menschlichen Umfeld
            einen wichtigen Beitrag zur Gesundheitsversorgung zu leisten. Entdecken Sie Ihre Karrieremöglichkeiten in
            unserem Haus.
        </p>
        <hr>
    ...
    <section id="job-listings" style="padding: 40px 0;">
        <h2 class="section-title" style="margin-bottom: 30px;">Aktuelle Stellenangebote (<?= count($jobs) ?> Positionen)
        </h2>
        ...
        <?php else: ?>
            ...
            <div class="job-grid"
                style="display: grid; gap: 25px; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));">

                <?php foreach ($jobs as $job): ?>
                    <article class="job-card"
                        style="border: 1px solid var(--color-border-subtle); padding: 25px; border-radius: 8px; box-shadow: var(--shadow-sm); background-color: var(--bg-white);">

                        <div class="job-header"
                            style="border-bottom: 2px solid var(--color-primary); padding-bottom: 15px; margin-bottom: 15px;">
                            <h3 style="color: var(--color-text-dark); margin: 0; font-size: 1.5rem;">
